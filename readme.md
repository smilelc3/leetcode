...
| 985 | [Sum of Even Numbers After Queries](https://leetcode.com/problems/sum-of-even-numbers-after-queries/) | [leetcode-c/sum-of-even-numbers-after-queries/sum-of-even-numbers-after-queries.c](sum-of-even-numbers-after-queries.c) | O(n) | 偶数运算 | O(n) |
