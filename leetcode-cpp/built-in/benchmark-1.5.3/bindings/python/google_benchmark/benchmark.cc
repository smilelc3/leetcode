...
namespace {
    ...
    py::enum_<Counter::Flags>(py_counter,
    "Flags")
    ...
    py::enum_<Counter::OneK>(py_counter,
    "OneK")
    ...
    = 0., py::arg("flags") = Counter::kDefaults,
    ...
    py::bind_map<benchmark::UserCounters>(m,
    "UserCounters");
